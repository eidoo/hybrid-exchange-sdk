(async () => {
  ...
  const erc20TokenService = new Erc20TokenService(web3, { erc20TokenSmartContractAddress: tokenAddress })
  ...
  const approveTransactionDraft = await erc20TokenService.getApproveTrasferTransactionDraft(
